...
struct TabLocationViewUX {
    ...
    static let Themes: [String: Theme] = {
        ...
        var theme = Theme()
        theme.URLFontColor = UIColor.clear //jesse 20180814
        theme.hostFontColor = UIColor.white
        theme.backgroundColor = UIConstants.PrivateModeLocationBackgroundColor
        themes[Theme.PrivateMode] = theme

        theme = Theme()
        theme.URLFontColor = UIColor.clear //jesse 20180814// BaseURLFontColor
...
class TabLocationView: UIView {
    ...
    fileprivate func updateTextWithURL() {  //jesse process URLbar text 201808141150
