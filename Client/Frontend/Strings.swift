...
// WX //jesse
extension Strings {
    public static let MenuWXLabel = NSLocalizedString("Menu.WXAction.Label", value: "WX", comment: "Label for the button, displayed in the menu, used to prepare for loading WX.")
}
