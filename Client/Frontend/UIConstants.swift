...
public struct UIConstants {
	...
	static let AppBackgroundColor = UIColor(red: 0 / 255, green: 122 / 255, blue: 255 / 255, alpha: 0.1) //jesse AR
    ...
    // Static fonts
    static let DefaultChromeSize: CGFloat = 24
    static let DefaultChromeSmallSize: CGFloat = 31
