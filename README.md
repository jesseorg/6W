...
follow the instructions to download, run brew 
install carthage

be careful of the the Env$ variable that sets the location of carthage because it gets put in the original named folder.
